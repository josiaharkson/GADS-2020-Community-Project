...
import { go_to_Q7 } from "../../../../store/actions/assist";
...
const Index = props => {
  ...
  return (
    <div className={Styles.body}>
      <AssisQ_Nav qNumber={6} onClick={() => onProceed()} />
...
const mapPropsToComponent = store => ({
  selectedSubstances_Q_1: store.assist.selectedSubstances_Q_1,
});

export default connect(mapPropsToComponent, { go_to_Q7 })(Index);
